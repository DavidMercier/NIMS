...
and to `Dr. M. Verdier <Marc.Verdier@simap.grenoble-inp.fr>` from (`SIMaP <http://simap.grenoble-inp.fr>`_ from France (Grenoble)), for long discussions and many advices about nanoindentation.
