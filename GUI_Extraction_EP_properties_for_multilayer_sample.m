...
set(gui.handles.value_indentertype_GUI, 'value', ...
    find(cell2mat(strfind(gui.config.Indenter_IDs, gui.config.Indenter_ID))));
...
set(gui.handles.value_indentermaterial_GUI, 'value', ...
    find(cell2mat(strfind(gui.config.Indenter_materials, gui.config.Indenter_material))));
...
gui.handles.value_bilayermodel_GUI = uicontrol('Parent', gcf,...
    ...
    'String', 'No_Bilayer_Model|Doerner&Nix|Gao_etal.|Bec_etal.|Hay_etal.|Perriot_etal.|Mencik_etal._linear',...
    'Value', 1,...
    'Callback', 'get_and_plot');
