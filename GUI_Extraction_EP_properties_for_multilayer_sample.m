...
gui.handles.cb_corr_King_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'checkbox',...
    'Position', [0.13 0.37 0.1 0.02],...
    'String', 'beta King1987',...
    'Value', 1,...
    'Callback', 'get_and_plot');

gui.handles.cb_corr_Hay_GUI = uicontrol('Parent', gcf,...
    'Units', 'normalized',...
    'Style', 'checkbox',...
    'Position', [0.13 0.34 0.1 0.02],...
    'String', 'gamma Hay1999',...
    'Value', 1,...
    'Callback', 'get_and_plot');
