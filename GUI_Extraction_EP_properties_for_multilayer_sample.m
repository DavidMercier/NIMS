...
%% Set Toolbox version
gui.config.name_toolbox = 'nanoind-data-analysis';
...
gui.handles.MainWindows = figure('Name', (strcat('Toolbox to analyze nanoindentation data - Version_', gui.config.version_toolbox)),...
    'NumberTitle', 'off',...
...
gui.handles.title_GUI_2 = uicontrol('Parent', gui.handles.MainWindows,...
    ...
    'String', strcat('Version_', gui.config.version_toolbox, ' - Copyright 2014 MERCIER David'),...
    'FontWeight', 'bold',...
    'FontSize', 10,...
    'HorizontalAlignment', 'center',...
    'ForegroundColor', 'red');
...
gui.handles.title_indentermaterial_GUI = uicontrol('Parent', gui.handles.MainWindows,...
    'Units', 'normalized',...
    'Style', 'text',...
...
gui.handles.value_indentermaterial_GUI = uicontrol('Parent', gui.handles.MainWindows,...
    'Units', 'normalized',...
    'Style', 'popup',...
...
set(gui.handles.value_indentermaterial_GUI, 'value', find(cell2mat(strfind(gui.config.Indenter_materials, gui.config.Indenter_material))));
...
gui.handles.python4fem = uicontrol('Parent', gui.handles.MainWindows,...
    'Units', 'normalized',...
    'Style', 'pushbutton',...
...
if flag_YAML
    ...
    fprintf('<a href="https://code.google.com/p/yamlmatlab/">Please download YAML Matlab code first...!</a>');
    dos(['start https://code.google.com/p/yamlmatlab/ ']);
    errordlg('Please download YAML Matlab code first... --> https://code.google.com/p/yamlmatlab/', 'Error');
end
